...
namespace BloodBankManagementSystem
{
    ...
    public partial class LoginWindow
    {
        ...
        private void LoginButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Password must be the combination of lowercase letters and numbers", "Message", MessageBoxButton.OK, MessageBoxImage.Asterisk);
            }

            else if (UsertypeComboBox.SelectedItem == null)
            {
                MessageBox.Show("Select User type!!", "Message", MessageBoxButton.OK, MessageBoxImage.Asterisk);
            }
            ...
            else if (UsertypeComboBox.Text == "Admin")
            {
                ...
                SqlCommand cmd=new SqlCommand("select Name,Password from admin where Name=@name and Password=@pass",Conn);
                ...
                {
                    MessageBox.Show("Error in Name or Password or both", "Message", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                }
            }            
        }
        ...
        private void  EventList()
        {
            ...
            SqlCommand cmd = new SqlCommand("select Name,Place,date from event", Conn);
